...
function parseDuration(durationString) {
    if(durationString[3]==='H' && durationString[6]==='M' && durationString[9]==='S'){
        return parseInt(durationString.substring(1,3))*3600 + parseInt(durationString.substring(4,6)) * 60 + parseInt(durationString.substring(7,9));
    }
    console.log(`Error parsing duration string: '${durationString}'`);
}
...
function parseTrackInfo(html, opts) {
    ...
    if (typeof extra === 'object' && typeof basic === 'object') {
        const track = {
            ...
            duration: parseDuration(getAdditionalPropertyValue(basic, 'duration')),
